...
function HealerHelper:InitSettings()
    HealerHelper:SetVersion("HealerHelper", "134149", "0.7.19")
    heahel_settings = HealerHelper:CreateFrame(
        {
            ...
            ["sw"] = 520,
            ["sh"] = 520,
            ["title"] = format("HealerHelper |T134149:16:16:0:0|t v|cff3FC7EB%s", "0.7.19")
        }
    )
    ...
    HealerHelper:CreateMinimapButton(
        {
            ...
            ["icon"] = 134149,
            ["dbtab"] = HEAHELPC,
            ["vTT"] = {{"HealerHelper |T134149:16:16:0:0|t", "v|cff3FC7EB0.7.192"}, {"Leftclick", "Toggle Settings"}},
            ["funcL"] = function()
