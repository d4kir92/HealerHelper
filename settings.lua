...
function HealerHelper:InitSettings()
    HealerHelper:SetVersion(134149, "0.7.68")
    ...
    HealerHelper:AppendCheckbox("MMBTN", HealerHelper:GetWoWBuild() ~= "RETAIL", function(sel, val)
        if val then
    ...
    HealerHelper:AppendCheckbox("LEVE", true, function() HealerHelper:UpdateLevels() end)
    HealerHelper:AppendCheckbox("FLAG", true, function() HealerHelper:UpdateFlagStatus() end)
    HealerHelper:AppendSlider("FLAGSCALE", 1, 0.6, 2, 0.1, 1, function() HealerHelper:UpdateFlagStatus() end)
    HealerHelper:AppendDropdown("LAYOUT", "BOTTOM", {
        ["BOTTOM"] = "BOTTOM",
        ["RIGHT"] = "RIGHT",
        ["LEFT"] = "LEFT",
    }, function() HealerHelper:UpdateHealBarsLayout() end)

    HealerHelper:AppendSlider("ACTIONBUTTONPERROW", 5, 2, 6, 1, 0, function() HealerHelper:UpdateHealBarsLayout() end)
    HealerHelper:AppendSlider("ROWS", 2, 1, 3, 1, 0, function() HealerHelper:UpdateHealBarsLayout() end)
    HealerHelper:AppendSlider("OFFSET", 2, 0, 20, 1, 0, function() HealerHelper:UpdateHealBarsLayout() end)
    HealerHelper:AppendSlider("GAPX", 6, 0, 20, 1, 0, function() HealerHelper:UpdateHealBarsLayout() end)
    HealerHelper:AppendSlider("GAPY", 6, 0, 20, 1, 0, function() HealerHelper:UpdateHealBarsLayout() end)
    HealerHelper:AppendCategory("RAID")
    HealerHelper:AppendCheckbox("RLEVE", true)
    HealerHelper:AppendCheckbox("RFLAG", true)
    HealerHelper:AppendSlider("RFLAGSCALE", 1, 0.6, 2, 0.1, 1, function() HealerHelper:UpdateFlagStatus() end)
    HealerHelper:AppendDropdown("RLAYOUT", "BOTTOM", {
        ["BOTTOM"] = "BOTTOM",
        ["RIGHT"] = "RIGHT",
        ["LEFT"] = "LEFT",
    }, function() HealerHelper:UpdateHealBarsLayout() end)

    HealerHelper:AppendSlider("RACTIONBUTTONPERROW", 5, 2, 6, 1, 0, function() HealerHelper:UpdateHealBarsLayout() end)
    HealerHelper:AppendSlider("RROWS", 2, 1, 3, 1, 0, function() HealerHelper:UpdateHealBarsLayout() end)
    HealerHelper:AppendSlider("ROFFSET", 2, 0, 20, 1, 0, function() HealerHelper:UpdateHealBarsLayout() end)
    HealerHelper:AppendSlider("RGAPX", 6, 0, 20, 1, 0, function() HealerHelper:UpdateHealBarsLayout() end)
    HealerHelper:AppendSlider("RGAPY", 6, 0, 20, 1, 0, function() HealerHelper:UpdateHealBarsLayout() end)
