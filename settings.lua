...
function HealerHelper:InitSettings()
    HealerHelper:SetVersion(134149, "0.8.5")
    HEAHELPC = HEAHELPC or {}
    ...
    AddCheckbox("ACTIONBUTTONS", true, function() HealerHelper:UpdateHealBarsLayout() end)
    AddDropdown("LAYOUT", "BOTTOM", LAYOUTCHOICES, function() HealerHelper:UpdateHealBarsLayout() end)
    AddSlider("ACTIONBUTTONPERROW", 5, 1, 6, 1, 0, function() HealerHelper:UpdateHealBarsLayout() end)
    ...
    AddCheckbox("RACTIONBUTTONS", true, function() HealerHelper:UpdateHealBarsLayout() end)
    AddDropdown("RLAYOUT", "BOTTOM", LAYOUTCHOICES, function() HealerHelper:UpdateHealBarsLayout() end)
    AddSlider("RACTIONBUTTONPERROW", 5, 1, 6, 1, 0, function() HealerHelper:UpdateHealBarsLayout() end)
